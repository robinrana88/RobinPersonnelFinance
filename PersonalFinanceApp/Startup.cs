...
using Finance.Infrastructure.Implementations.Repositories;

using Finance.Infrastructure.Implementations.Services.Account;
using Finance.Infrastructure.Implementations.Services.User;
...
namespace PersonalFinanceApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IDbContext, FinanceContext>();
